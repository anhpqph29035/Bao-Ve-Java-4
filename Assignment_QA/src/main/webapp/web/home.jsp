        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="filter__controls">
                    <li class="active" data-filter="*">Shoping Now !!!</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row product__filter">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/sanpham/${u.anhCTSP}">
                                    </div>
                                    <div class="product__item__text">
                                        <h6>${u.sanPham.tenSP}</h6>
                                        <a href="/detail?id=${u.idCTSP}" class="add-cart">See Detail</a>
                                        <h5>${u.giaBan} $</h5>
                                    </div>
                                </div>
                            </div>
