...
<div class="text-start mb-3 mt-4">
    ...
    <a href="showAddCV" class="btn btn-success">Thêm</a>
</div>
<table class="table table-bordered table-sm container text-center">
    ...
    <c:forEach items="${listCV}" var="u">
        <tr>
            ...
            <td>${u.tenCV}</td>
            <td>
                <a href="/removeCV?id=${u.idCV}" class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa không ?')" >Xóa</a>
                <a href="/detailCV?id=${u.idCV}" class="btn btn-primary">Detail</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
